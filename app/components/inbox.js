...
inboxData = [
  {
    ...
    status: "vehicula",
    avatar:
      "https://robohash.org/recusandaeperspiciatisunde.png?size=50x50&set=set1",
  ...
  },
  {
    ...
    status: "venenatis",
    avatar:
      "https://robohash.org/sapientereiciendissed.jpg?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "dui",
    avatar:
      "https://robohash.org/eligendierrordelectus.png?size=50x50&set=set1",
    message:
      "Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis."
  },
  {
    ...
    status: "ipsum",
    avatar:
      "https://robohash.org/consequunturaconsequatur.bmp?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "tempus",
    avatar:
      "https://robohash.org/explicabovoluptasvoluptatibus.png?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "nisl",
    avatar:
      "https://robohash.org/corporisnatusconsequuntur.png?size=50x50&set=set1",
    message: "In congue."
  },
  {
    id: 21,
    ...
    status: "eu",
    avatar:
      "https://robohash.org/eligendiexpeditaatque.png?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "ut",
    avatar:
      "https://robohash.org/evenietfugiatconsequatur.bmp?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "non",
    avatar:
      "https://robohash.org/fugiatvoluptatelaboriosam.bmp?size=50x50&set=set1",
    message:
  ...
  },
  {
    ...
    status: "felis",
    avatar:
      "https://robohash.org/eumlaudantiumreiciendis.bmp?size=50x50&set=set1",
    message:
    ...
    return (
      <ScrollView style={styles.container}>
        <View>
          ...
          <View>
            <Text
              style={{ margin: 5, marginLeft: 0, color: "#888", fontSize: 18 }}
            >
              Messages
            </Text>
          </View>
          ...
          <ListView
            ...
            renderRow={rowData => (
              <EachMessage {...this.props} rowData={rowData} />
            )}
          />
        </View>
      </ScrollView>
